                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#dashboard">
                            <div class="pull-left"><i class="ti-home"></i><span
                                    class="right-nav-text">{{trans('main-sidebar-trans.Dashboard')}}</span>
                            </div>
...
<!--                    <li>
                    ...
                    <li>
                        <a href="{{ url('/' . $page='slider') }}"><i class="ti-menu-alt"></i><span
                                class="right-nav-text">Slider</span> </a>
                    </li>
                    <!-- menu item chat-->
                    <li>
                    ...
                    <!-- menu item mailbox-->
                    <li>
                        <a href="{{ url('/' . $page='SEO-Page') }}"><i class="ti-email"></i><span
                                class="right-nav-text">SEO
                                box</span> <span class="badge badge-pill badge-warning float-right mt-1">HOT</span> </a>
                    </li>

                    <!-- menu item Top Management-->
                    <li>
                        <a href="{{ url('/' . $page='Top-Management') }}"><i class="ti-comments"></i><span
                                class="right-nav-text">Top Management
                            </span></a>
                    </li>
                    ...
                    <li>
                        <a href="{{ url('/' . $page='getNotification') }}"><i class="ti-comments"></i><span
                                class="right-nav-text">Get Notification
                            </span></a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="users" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">User Permissions</a>
                            </li>
                    ...
                    <!-- menu item social media-->
                    <li>
                        <a href="{{ url('/' . $page='socialmedia') }}"><i class="ti-comments"></i><span
                                class="right-nav-text">social media
                            </span></a>
                    </li>
